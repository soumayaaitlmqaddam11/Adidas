            ...
            <div class="h-100">
                ...
                <ul class="sidebar_nav">
                    ...
                    <li class="sidebar_item active">
                        <a href="/user" class="sidebar_link">Users</a>
                    </li>
                    <li class="sidebar_item">
                        <a href="/role" class="sidebar_link">Roles</a>
                    </li>
                </ul>
                    ...
                    <div class="col s12">
                        ...
                        <form action="/update/traitement" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="role_id" data-placeholder="choose a rol">
                            ...
                            <a  href="/user" type="button" class="btn btn-outline-primary">Cancel</a>
