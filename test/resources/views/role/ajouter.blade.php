                ...
                <div class="navbar  gap-4">
                    ...
                    <div class="card new w-auto">
                        <div class="list-group list-group-light">
                            ...
                            <div class="list-group-item px-3 text-center"><a href="#">View all notifications</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col s12">
                        ...
                        @endif
                        <form action="/ajouter/traitementRole" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <a href="/role" type="button" class="btn btn-outline-primary">Cancel</a>
